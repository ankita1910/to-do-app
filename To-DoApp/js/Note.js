	...
	propTypes: {
		count: function(props, propName) {
			if(typeof props[propName] != number) {
				return new Error('The count property must be number');
			}
	...
	render: function() {
		return (
			<div className="board">
				...
				<button className="btn btn-success btn-sm glyphicon glyphicon-plus" onClick={this.add.bind(null, "New Note")} />
			</div>
		);
	}
});
